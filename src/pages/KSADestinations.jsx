...
const KSADestinations = () => {
    ...
    const Hero = (
        <SubPageHero
            title="Destinations"
            subtitle="Explore a world of diverse destinations, from iconic landmarks and vibrant cities to stunning natural landscapes. Discover tailored travel options that showcase rich heritage and modern excitement across the globe"
            image="https://images.unsplash.com/photo-1488085061387-422e29b40080?w=1920&q=80"
            onExploreClick={() => document.getElementById('destinations-grid').scrollIntoView({ behavior: 'smooth' })}
        />
    );

    const DestinationsContent = (
        <div id="destinations-grid" className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            {/* Main Content */}
            <div className="lg:col-span-8">
                ...
                {filteredPackages.length === 0 && (
                    <div className="text-center py-20">
                        <p className="text-xl text-gray-500">No packages found matching your search.</p>
                    </div>
                )}
            </div>
...
export default KSADestinations;
