...
const SaudiEvents = () => {
    ...
    // Filter packages for 'Entertainment & Events' category
    const filteredPackages = useMemo(() => {
        return packages.filter(pkg =>
            pkg.subType === 'Visit Saudi' &&
            pkg.ksaCategory === 'Entertainment & Events' &&
    ...
    const Hero = (
        <SubPageHero
            title={<>Saudi <span className="text-primary">Events</span></>}
            subtitle="Experience world-class entertainment, international festivals, and thrilling sporting events. Join the excitement in the heart of the region."
            image="https://images.unsplash.com/photo-1540575861501-7ad05823c93b?w=1920&q=80"
