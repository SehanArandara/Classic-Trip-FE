...
const KSASpecialOffers = () => {
    const [searchQuery, setSearchQuery] = useState('');
    const [currentPage, setCurrentPage] = useState(1);
    const packagesPerPage = 20;

    // Filter packages based on isSpecialOffer flag and search query
    ...
    const Hero = (
        <SubPageHero
            ...
            subtitle="Unlock exclusive deals and promotions crafted to enhance your travel experience affordably. Our special offers deliver exceptional value while maintaining top-tier quality and memorable moments."
            image="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1920&q=80"
            onExploreClick={() => document.getElementById('offers-grid').scrollIntoView({ behavior: 'smooth' })}
        />
    );

    const OffersContent = (
        <div id="offers-grid" className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            {/* Main Content */}
            <div className="lg:col-span-8">
                ...
                {filteredPackages.length === 0 && (
                    <div className="text-center py-20">
                        <p className="text-xl text-gray-500">No special offers found matching your search.</p>
                    </div>
                )}
            </div>
    ...
    return (
        <KSAPageLayout
            ...
            breadcrumbPath={[
                ...
                { label: 'Special Offers', isActive: true }
            ]}
            hero={Hero}
            packages={OffersContent}
            services={null}
            showBlog={false}
...
export default KSASpecialOffers;
